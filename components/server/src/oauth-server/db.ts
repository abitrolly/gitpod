...
function getVSCodeClientName(protocol: "vscode" | "vscode-insiders" | "vscodium" | "cursor") {
    let productName = "VS Code";
    switch (protocol) {
        case "vscodium":
